;; Trading contract - Clarity 3 (epoch 3.0)
...
;; Clarity 3 version with OLD as-contract syntax
(define-public (zest-withdraw-fund
  ...
  (begin
    ...
    ;; Step 1: Withdraw sBTC collateral from Zest (OLD as-contract syntax)
    (try! (contract-call? .zest-interface-v3 zest-withdraw
      borrow-helper-trait
      lp-sbtc-trait
      pool-reserve-data
      sbtc-token-trait
    ...
    (print { action: "zest-withdraw-fund-claims", data: { collateral-amount: collateral-amount } })
    (ok true)
  )
)
